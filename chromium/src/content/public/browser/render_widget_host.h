...
class CONTENT_EXPORT RenderWidgetHost : public IPC::Sender {
 public:
  ...
  // Request a callback to be invoked whenever the corresponding
  // RenderWidgetHostView has had a new frame passed to it.
  virtual void RequestFrameCallback(const base::Closure& callback) = 0;
