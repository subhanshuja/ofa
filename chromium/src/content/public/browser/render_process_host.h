...
class CONTENT_EXPORT RenderProcessHost : public IPC::Sender,
 ...
 public:
  ...
  virtual void SignalTurboImageQuality(
      net::TurboImageQuality image_quality) = 0;
  ...
  // Called to signal image quality setting used by Turbo proxy to all renderer
  // child processes.
  static void SignalAllTurboImageQuality(net::TurboImageQuality image_quality);
};
