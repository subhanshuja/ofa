...
class NavigationEntry {
 public:
  ...
  // When net code decided not to use Turbo proxy server, for example when the
  // request turned out to be an Intranet request, set this flag.
  virtual void SetBypassTurbo(bool bypass_turbo) = 0;
  virtual bool GetBypassTurbo() const = 0;
