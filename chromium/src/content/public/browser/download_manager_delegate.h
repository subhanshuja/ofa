...
class CONTENT_EXPORT DownloadManagerDelegate {
 public:
  ...
  // Called when the download system wants to resume a download that doesn't
  // have a WebContents connected to it. The delegate can return NULL.
  virtual WebContents* GetWebContentsForResumableDownload();
