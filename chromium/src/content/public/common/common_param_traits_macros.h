...
IPC_ENUM_TRAITS_MAX_VALUE(content::SecurityStyle, content::SECURITY_STYLE_LAST)
...
IPC_STRUCT_TRAITS_BEGIN(content::WebPreferences)
  ...
  IPC_STRUCT_TRAITS_MEMBER(video_compression_enabled)
...
#if defined(OS_ANDROID)
  IPC_STRUCT_TRAITS_MEMBER(text_wrapping_enabled)
