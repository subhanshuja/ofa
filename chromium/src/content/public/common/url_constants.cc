...
const char kLegacyOperaUIScheme[] = "browser";
#elif defined(OPERA_TVSDK) || defined(OPERA_WAM)
const char kLegacyOperaUIScheme[] = "opera";
#endif  // defined(OPERA_TVSDK) || defined(OPERA_WAM)
