...
void NavigationEntryImpl::SetBypassTurbo(bool bypass_turbo) {
  bypass_turbo_ = bypass_turbo;
}

bool NavigationEntryImpl::GetBypassTurbo() const {
  return bypass_turbo_;
}
...
std::unique_ptr<NavigationEntryImpl> NavigationEntryImpl::CloneAndReplace(
  ...
  copy->bypass_turbo_ = bypass_turbo_;
