...
void WebContentsObserverProxy::WebContentsDestroyed() {
  // Since RVHs might shutdown asynchronously we must make sure that the
  // Android RVHs doesn't call into ContentViewCore which might be in the
  // process of shutting down.

  // This kind of code is doomed to break.
  const WebContentsImpl* web_contents_impl = static_cast<const WebContentsImpl*>(web_contents());
