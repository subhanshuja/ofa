...
class ContentViewCoreImpl : public ContentViewCore,
 ...
 public:
  ...
  void SuspendAudio(JNIEnv* env, jobject obj);
  void ResumeSuspendedAudio(JNIEnv* env, jobject obj);
  ...
  void SetAccessibilityEnabled(JNIEnv* env,
                               const base::android::JavaParamRef<jobject>& obj,
                               bool enabled);
  void RequestSelectionPreview(JNIEnv* env,
                               jobject obj,
                               jint focus_x,
                               jint focus_y,
                               jint focus_width,
  ...
  void OnTouchHandleEvent(ui::TouchHandleEventType event, const gfx::Rect& bounds);

  void StartContentIntent(const GURL& content_url, bool is_main_frame);

  void ShowSelectionPreview(const SkBitmap& preview_bitmap,
