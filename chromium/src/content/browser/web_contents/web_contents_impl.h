...
class CONTENT_EXPORT WebContentsImpl
 ...
 public:
  ...
  void UpdatePlayState(
      blink::WebAudioElementPlayState play_state) override;
 ...
 private:
  ...
  // This private flag will be set when the page is loaded completely and
  // the loading process had not been aborted by the user.
