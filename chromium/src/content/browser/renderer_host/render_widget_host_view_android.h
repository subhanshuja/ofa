...
class CONTENT_EXPORT RenderWidgetHostViewAndroid
 ...
 public:
  ...
  void SelectionStateChanged(bool is_start_anchor) override;
  ...
  void ShowSelectionPreview(
      ...
      const gfx::Rect& focus_rect) override;
  ...
  void OnTouchHandleEvent(ui::TouchHandleEventType event,
 ...
 private:
  ...
  // The most recent content size that was pushed to the surface layer.
