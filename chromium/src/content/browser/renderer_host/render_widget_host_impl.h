...
class CONTENT_EXPORT RenderWidgetHostImpl : public RenderWidgetHost,
 ...
 public:
  ...
  void RequestFrameCallback(const base::Closure& callback) override;
 ...
 private:
  ...
  void OnSelectionStateChanged(bool is_start_anchor);
  ...
  // Frame callback list invoked after the content of the corresponding
  // RenderWidgetHostView has been passed a new frame.
  typedef std::vector<base::Closure> FrameCallbackList;
  FrameCallbackList frame_callbacks_;
