...
class CONTENT_EXPORT RenderWidgetHostViewBase : public RenderWidgetHostView,
 ...
 public:
  ...
  // Notifies the View that the renderer selection state has changed.
  virtual void SelectionStateChanged(bool is_start_anchor) = 0;
  ...
  // Shows the selection preview. |preview_bitmap| is the new preview bitmap.
  // The bitmap is only valid for the duration of the call. |focus_rect| is the
  // selection focus point used when generating the preview bitmap.
  virtual void ShowSelectionPreview(
