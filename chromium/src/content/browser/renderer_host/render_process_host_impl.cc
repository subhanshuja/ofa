...
void RenderProcessHostImpl::PropagateBrowserCommandLineToRenderer(
  ...
  static const char* const kSwitchNames[] = {
    ...
    cc::switches::kTileCompressionHeuristic,
    ...
    cc::switches::kLogFPSCounter,
    cc::switches::kLogTileMemoryUsage,
...
void RenderProcessHostImpl::SignalTurboImageQuality(
    net::TurboImageQuality image_quality) {
  Send(new ChildProcessMsg_SignalTurboImageQuality(
      static_cast<int>(image_quality)));
}
...
void RenderProcessHost::SignalAllTurboImageQuality(
    net::TurboImageQuality image_quality) {
  iterator iter(AllHostsIterator());
  while (!iter.IsAtEnd()) {
    iter.GetCurrentValue()->SignalTurboImageQuality(image_quality);
    iter.Advance();
  }
}
