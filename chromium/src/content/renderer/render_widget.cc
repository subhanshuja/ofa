...
void RenderWidget::SetTextWrapInterestPoint(const gfx::Point& interest_point) {
  webwidget_internal_->setTextWrapInterestPoint(interest_point);
}

void RenderWidget::StartTextWrap() {
  webwidget_internal_->startTextWrap();
}
...
void RenderWidget::UpdateSelectionBounds() {
  ...
  if (selection_anchor_first_ != webwidget_internal_->isSelectionAnchorFirst()) {
    selection_anchor_first_ = webwidget_internal_->isSelectionAnchorFirst();
    Send(new ViewHostMsg_SelectionStateChanged(
             routing_id_, selection_anchor_first_));
  }
