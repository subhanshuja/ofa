...
class CONTENT_EXPORT MediaInfoLoader : private blink::WebURLLoaderClient {
 public:
  ...
  // Returns a valid URL if this media resource has been redirected to a
  // a video compressor.
  GURL GetCompressedVideoUrl() const;
 ...
 private:
  ...
  // Valid if turbo has redirected request to a video compressor
  GURL compressed_video_url_;
