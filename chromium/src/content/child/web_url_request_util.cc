...
int GetLoadFlagsForWebURLRequest(const blink::WebURLRequest& request) {
  ...
  if (request_context == WebURLRequest::RequestContextObject ||
      request_context == WebURLRequest::RequestContextVideo ||
      request_context == WebURLRequest::RequestContextAudio)
    load_flags |= net::LOAD_MEDIA_CONTENT;
