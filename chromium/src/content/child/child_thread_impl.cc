...
bool ChildThreadImpl::OnMessageReceived(const IPC::Message& msg) {
  ...
  IPC_BEGIN_MESSAGE_MAP(ChildThreadImpl, msg)
    ...
    IPC_MESSAGE_HANDLER(ChildProcessMsg_SignalTurboImageQuality,
                        OnSignalTurboImageQuality)
...
void ChildThreadImpl::OnSignalTurboImageQuality(int image_quality) {
  content::SignalTurboImageQuality(image_quality);
}
