...
_LANGUAGE_CHARSET_PAIR = {
  ...
  'be'          : '042304e3',
  'kk'          : '043f04e3',
  # No codepage for Frisian, use unicode(1200).
  'fy'          : '046204b0',
  # No codepage for Gaelic - Scotland, use unicode(1200).
  'gd'          : '043c04b0',
  # No codepage for Montenegro, use unicode(1200).
  'me'          : '081a04b0',
  'mk'          : '042f04e3',
  # No codepage for Punjabi, use unicode(1200).
  'pa'          : '044604b0',
  'uz'          : '084304e3',
  'fake-bidi'   : '040d04e7',
}
...
_LANGUAGE_DIRECTIVE_PAIR = {
  ...
  'fil'         : 'LANG_FILIPINO, SUBLANG_DEFAULT',
  ...
  'be'          : 'LANG_BELARUSIAN, SUBLANG_DEFAULT',
  'kk'          : 'LANG_KAZAK, SUBLANG_DEFAULT',
  'az'          : 'LANG_AZERI, SUBLANG_DEFAULT',
  'fy'          : 'LANG_FRISIAN, SUBLANG_DEFAULT',
  'uz'          : 'LANG_UZBEK, SUBLANG_DEFAULT',
  'mk'          : 'LANG_MACEDONIAN, SUBLANG_DEFAULT',
  'me'          : 'LANG_SERBIAN, SUBLANG_SERBIAN_LATIN',
  'gd'          : 'LANG_SCOTTISH_GAELIC, SUBLANG_DEFAULT',
