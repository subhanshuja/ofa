...
#ifndef CC_RASTER_TEXTURE_COMPRESSOR_ATC_H_
#define CC_RASTER_TEXTURE_COMPRESSOR_ATC_H_

#include "cc/raster/texture_compressor.h"

namespace cc {

class CC_EXPORT TextureCompressorATC : public TextureCompressor {
 private:
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(TextureCompressorATC);
};

}  // namespace cc

#endif  // CC_RASTER_TEXTURE_COMPRESSOR_ATC_H_
