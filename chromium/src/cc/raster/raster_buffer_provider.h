...
class CC_EXPORT RasterBufferProvider {
 public:
  ...
  virtual ResourceFormat GetResourceFormat(bool must_support_alpha, bool no_compression) const = 0;

  // Determine if the resource requires swizzling.
  virtual bool IsResourceSwizzleRequired(bool must_support_alpha, bool no_compression) const = 0;
