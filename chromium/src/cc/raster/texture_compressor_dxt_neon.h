...
#ifndef CC_RASTER_TEXTURE_COMPRESSOR_DXT_NEON_H_
#define CC_RASTER_TEXTURE_COMPRESSOR_DXT_NEON_H_

#include "cc/raster/texture_compressor.h"

namespace cc {

class CC_EXPORT TextureCompressorDXT_NEON : public TextureCompressor {
 private:
 ...
 private:
  DISALLOW_COPY_AND_ASSIGN(TextureCompressorDXT_NEON);
};

}  // namespace cc

#endif  // CC_RASTER_TEXTURE_COMPRESSOR_DXT_NEON_H_
