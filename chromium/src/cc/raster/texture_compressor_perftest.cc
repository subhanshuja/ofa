...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Combine(::testing::Values(TextureCompressor::kQualityLow,
                       ...
                       ::testing::Values(TextureCompressor::kFormatATC,
                                         TextureCompressor::kFormatATCIA,
                                         TextureCompressor::kFormatDXT1,
                                         TextureCompressor::kFormatDXT5,
                                         TextureCompressor::kFormatETC1)));
