...
class CC_EXPORT OneCopyRasterBufferProvider : public RasterBufferProvider {
 public:
  ...
  ResourceFormat GetResourceFormat(bool must_support_alpha, bool no_compression) const override;
  bool IsResourceSwizzleRequired(bool must_support_alpha, bool no_compression) const override;
 ...
 private:
  ...
  const ResourceFormat preferred_tile_format_with_alpha_;
