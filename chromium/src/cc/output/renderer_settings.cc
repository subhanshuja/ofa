...
RendererSettings::RendererSettings()
    : allow_antialiasing(true),
      ...
      tile_compression_heuristic_flags(TILE_COMPRESSION_HEURISTIC_GRADIENT |
                                       TILE_COMPRESSION_HEURISTIC_IMAGE),
      texture_id_allocation_chunk_size(64),
      use_gpu_memory_buffer_resources(false),
      preferred_tile_format(PlatformColor::BestTextureFormat()),
      preferred_tile_format_with_alpha(PlatformColor::BestTextureFormat()) {}
...
void RendererSettings::ToProtobuf(proto::RendererSettings* proto) const {
  ...
  proto->set_preferred_tile_format_with_alpha(preferred_tile_format_with_alpha);
...
void RendererSettings::FromProtobuf(const proto::RendererSettings& proto) {
  ...
  DCHECK_LE(proto.preferred_tile_format_with_alpha(),
            static_cast<uint32_t>(RESOURCE_FORMAT_MAX));
  preferred_tile_format_with_alpha =
      static_cast<ResourceFormat>(proto.preferred_tile_format_with_alpha());
...
bool RendererSettings::operator==(const RendererSettings& other) const {
  return allow_antialiasing == other.allow_antialiasing &&
         ...
         preferred_tile_format_with_alpha ==
            other.preferred_tile_format_with_alpha &&
