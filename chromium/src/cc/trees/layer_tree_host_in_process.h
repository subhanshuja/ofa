...
class CC_EXPORT LayerTreeHostInProcess : public LayerTreeHost {
 public:
  ...
  void SetEnableTextWrap(bool enable_text_wrap) override;
  void DidPinchGesture(const gfx::Point& anchor) override;
 ...
 private:
  ...
  bool text_wrap_enabled_;
  bool text_wrap_pending_;
