...
class CC_EXPORT TileDrawInfo {
 public:
  ...
  bool attempt_compress() const { return attempt_compress_; }
 ...
 private:
  ...
  void set_attempt_compress(bool attempt_compress) {
    attempt_compress_ = attempt_compress;
  }

  void set_oom() { mode_ = OOM_MODE; }

  Mode mode_;
  bool attempt_compress_;
