...
class CORE_EXPORT Page final : public GarbageCollectedFinalized<Page>,
 ...
 public:
  ...
  // The play state of a media element has changed, schedule a
  // re-calculation of the aggregate play state.
  void invalidatePlayState();
 ...
 private:
  ...
  void playStateTimerFired(TimerBase*);
  ...
  Timer<Page> m_playStateTimer;
  WebAudioElementPlayState m_playState;
