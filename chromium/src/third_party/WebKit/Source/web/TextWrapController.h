...
class TextWrapController final: public GarbageCollectedFinalized<TextWrapController> {

public:
    static TextWrapController* create()
    {
        return new TextWrapController;
    }
