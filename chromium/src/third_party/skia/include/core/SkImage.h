...
public:
    ...
    static sk_sp<SkImage> MakeFromGenerator(SkImageGenerator*, const SkIRect* subset = nullptr,
                                            bool decodedWithLosslessCodec = false);
    ...
    */
    ...
    virtual bool isDecodedWithLosslessCodec() const { return false; }
    virtual void setIsDecodedWithLosslessCodecForTest(bool is_lossless) {}
