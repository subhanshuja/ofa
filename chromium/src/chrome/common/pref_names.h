...
extern const char kProxyForLocalServers[];
...
extern const char kTurboEnabled[];
extern const char kTurboUrlBlacklist[];
extern const char kTurboClientID[];
extern const char kTurboSuggestedServer[];
