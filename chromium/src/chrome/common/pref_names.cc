...
const char kProxyForLocalServers[] = "net.use_proxy_for_local_servers";
...
// Boolean, true when Turbo is enabled.
const char kTurboEnabled[] = "turbo.enabled";
// Blocks Turbo access to the listed host patterns.
const char kTurboUrlBlacklist[] = "turbo.url_blacklist";
// Unique generated client ID.
const char kTurboClientID[] = "turbo.client_id";
// Last suggested server received from the proxy.
const char kTurboSuggestedServer[] = "turbo.suggested_server";
