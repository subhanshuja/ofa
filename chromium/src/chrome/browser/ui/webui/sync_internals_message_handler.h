...
#if defined(OPERA_SYNC)
  void HandleExitDuplicationBackoff(const base::ListValue* args);
#endif  // OPERA_SYNC
...
#if defined(OPERA_SYNC)
  // DuplicateTrackerObserver implementation.
  void OnTrackerStateChanged(opera::DuplicateTracker* tracker) override;
  void OnTrackerStatisticsUpdated(opera::DuplicateTracker* tracker) override;
  void OnDuplicateAppeared(opera::DuplicateTracker* tracker,
                           opera::FlawId id) override;
  void OnFlawAppeared(opera::DuplicateTracker* tracker,
                      opera::FlawId id) override;
  void OnDuplicateDisappeared(opera::DuplicateTracker* tracker,
                              opera::FlawId id) override;
  void OnFlawDisappeared(opera::DuplicateTracker* tracker,
                         opera::FlawId id) override;
  void OnFlawProcessingStarted(opera::DuplicateTracker* tracker,
                         opera::FlawId id) override {}
  void OnDebugStatsUpdated(opera::DuplicateTracker * tracker) override;
#endif  // OPERA_SYNC
...
#if defined(OPERA_SYNC)
  opera::DuplicateTracker* GetDuplicateTracker();
#endif  // OPERA_SYNC
