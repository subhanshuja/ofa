...
class ChromeNetworkDelegate : public net::NetworkDelegateImpl {
 public:
  ...
  void set_turbo_blacklist_manager(
      const policy::TurboBlacklistManager* turbo_blacklist_manager) {
    turbo_blacklist_manager_ = turbo_blacklist_manager;
  }
  ...
  void set_turbo_settings(scoped_refptr<TurboSettings> turbo_settings);
  ...
  void set_turbo_client_id(StringPrefMember* turbo_client_id) {
    turbo_client_id_ = turbo_client_id;
  }
 ...
 private:
  ...
  scoped_refptr<TurboSettings> turbo_settings_;
  ...
  StringPrefMember* turbo_client_id_;
  StringPrefMember* allowed_domains_for_apps_;

  // Weak, owned by our owner.
  const policy::URLBlacklistManager* url_blacklist_manager_;
  const policy::TurboBlacklistManager* turbo_blacklist_manager_;
