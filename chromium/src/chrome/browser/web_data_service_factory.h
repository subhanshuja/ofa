...
#if defined(OPERA_SYNC)
  // Returns the TokenCacheWebData associated with the |profile|.
  static scoped_refptr<opera::oauth2::TokenCacheWebData>
  GetTokenCacheWebDataForProfile(Profile* profile,
                                 ServiceAccessType access_type);
#endif  // OPERA_SYNC
