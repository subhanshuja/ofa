...
void ProfileIOData::InitializeOnUIThread(Profile* profile) {
  ...
  if (!profile->IsOffTheRecord()) {
    params->turbo_settings = TurboSettingsFactory::GetForProfile(profile);
  }
  ...
  turbo_blacklist_manager_.reset(new policy::TurboBlacklistManager(pref_service));
...
void ProfileIOData::Init(
  ...
  network_delegate->set_turbo_blacklist_manager(turbo_blacklist_manager_.get());
  ...
  if (!IsOffTheRecord()) {
    network_delegate->set_turbo_client_id(&turbo_client_id_);
    network_delegate->set_turbo_settings(profile_params_->turbo_settings.get());
  }
...
void ProfileIOData::ShutdownOnUIThread(
  ...
  if (turbo_blacklist_manager_.get())
    turbo_blacklist_manager_->ShutdownOnUIThread();
