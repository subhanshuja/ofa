...
void RegisterProfilePrefs(user_prefs::PrefRegistrySyncable* registry) {
  ...
  registry->RegisterBooleanPref(prefs::kProxyForLocalServers, true);
  registry->RegisterStringPref(prefs::kTurboClientID, "");
  registry->RegisterDictionaryPref(prefs::kTurboUrlBlacklist);
  registry->RegisterStringPref(prefs::kTurboSuggestedServer, "");
