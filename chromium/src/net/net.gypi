...
# that beyond the simple one-level-deep dictionary of values.
{
  'variables': {
    ...
    'net_non_nacl_sources': [
      ...
      'turbo/turbo_cache_entry.cc',
      'turbo/turbo_cache_enumerator.cc',
      'turbo/turbo_cache_synchronizer.cc',
      'turbo/turbo_certificate.cc',
      'turbo/turbo_session_pool.cc',
      'turbo/turbo_cookie_synchronizer.cc',
      'turbo/turbo_utilities.cc',
