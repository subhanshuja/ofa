...
// Indicates that we want to bypass the turbo proxy for a load.
LOAD_FLAG(BYPASS_TURBO, 1 << 28)

// Indicates that we want to force use of the turbo proxy for a load.
LOAD_FLAG(FORCE_TURBO, 1 << 29)

// Indicates that this is a load of media content.
LOAD_FLAG(MEDIA_CONTENT, 1 << 30)
