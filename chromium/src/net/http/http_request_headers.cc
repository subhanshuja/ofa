...
const char HttpRequestHeaders::kSaveData[] = "Save-Data";
const char HttpRequestHeaders::kTransferEncoding[] = "Transfer-Encoding";
const char HttpRequestHeaders::kOperaInfo[] = "X-Opera-Info";
const char HttpRequestHeaders::kOperaID[] = "X-Opera-ID";
const char HttpRequestHeaders::kOperaHost[] = "X-Opera-Host";
const char HttpRequestHeaders::kOperaOA[] = "X-OA";
const char HttpRequestHeaders::kOperaOB[] = "X-OB";
const char HttpRequestHeaders::kOperaOC[] = "X-OC";
