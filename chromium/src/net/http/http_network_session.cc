...
HttpNetworkSession::HttpNetworkSession(const Params& params)
    : net_log_(params.net_log),
      ...
      turbo_session_pool_(new TurboSessionPool(this)),
      params_(params) {
...
HttpNetworkSession::~HttpNetworkSession() {
  ...
  spdy_session_pool_.RemoveObserver(turbo_session_pool_.get());
...
base::WeakPtr<TurboSessionPool> HttpNetworkSession::turbo_session_pool() {
  DCHECK(turbo_session_pool_);
  return turbo_session_pool_->AsWeakPtr();
}
