...
class HttpCache::Transaction : public HttpTransaction {
 ...
 private:
  ...
  // The cached response was loaded through the Turbo proxy with settings that
  // are incompatible with current settings.  A new request is required.
  bool turbo_invalid_response_;
