...
class NET_EXPORT HttpCache : public HttpTransactionFactory,
 ...
 private:
  ...
  // Helper function to set this instance as the HttpCache for current session,
  // if the session exists.
  void SetHttpCacheForCurrentSession(bool clear);
  ...
  static void OnCacheInitialized(const base::WeakPtr<HttpCache>& cache,
                                 const CompletionCallback& callback,
                                 int result);
