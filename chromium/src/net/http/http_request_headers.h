...
class NET_EXPORT HttpRequestHeaders {
 public:
  ...
  static const char kOperaInfo[];
  static const char kOperaID[];
  static const char kOperaHost[];
  static const char kOperaOA[];
  static const char kOperaOB[];
  static const char kOperaOC[];
