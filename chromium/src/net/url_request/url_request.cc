...
void URLRequest::set_turbo_request_type(const std::string& value) {
  turbo_request_type_ = value;
}

void URLRequest::set_turbo_main(const std::string& value) {
  turbo_main_ = value;
}

void URLRequest::set_bypass_turbo(bool value) {
  bypass_turbo_ = value;
}
