...
void ProxyServer::set_turbo_connection_id(int id) {
  DCHECK(turbo_connection_id_ == INT_MIN);
  DCHECK(is_http() || is_https());
  turbo_connection_id_ = id;
}
