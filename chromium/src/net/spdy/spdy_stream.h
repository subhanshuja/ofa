...
class NET_EXPORT_PRIVATE SpdyStream {
 public:
  ...
  // Has this (pushed) stream been reported to the Turbo proxy as unclaimed.
  bool turbo_reported_unclaimed() { return turbo_reported_unclaimed_; }
  void set_turbo_reported_unclaimed() { turbo_reported_unclaimed_ = true; }
 ...
 private:
  ...
  bool turbo_reported_unclaimed_;
