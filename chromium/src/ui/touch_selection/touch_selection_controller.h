...
#include "ui/touch_selection/touch_handle_event_type.h"
...
class UI_TOUCH_SELECTION_EXPORT TouchSelectionControllerClient {
 public:
  ...
  virtual void OnTouchHandleEvent(TouchHandleEventType event,
...
class UI_TOUCH_SELECTION_EXPORT TouchSelectionController
 ...
 public:
  ...
  void set_is_start_anchor(bool is_start_anchor) {
    is_start_anchor_ = is_start_anchor;
  }
