...
class BookmarkLoadDetails {
 public:
  ...
  CustomBookmarkNodes* custom_nodes() { return &custom_nodes_; }
  CustomBookmarkNodes release_custom_nodes() {
    CustomBookmarkNodes copy = custom_nodes_;
    custom_nodes_.clear();
    return copy;
  }
...
class BookmarkStorage : public base::ImportantFileWriter::DataSerializer {
 public:
  ...
  // If there is a scheduled save, save now
