...
InvalidatorRegistrar::InvalidatorRegistrar()
    ...
    : state_(OperaInvalidatorState(DEFAULT_INVALIDATION_ERROR)) {
}
#else
...
#if defined(OPERA_SYNC)
void InvalidatorRegistrar::UpdateInvalidatorState(OperaInvalidatorState state) {
#else
...
#if defined(OPERA_SYNC)
OperaInvalidatorState InvalidatorRegistrar::GetInvalidatorState() const {
#else
