...
TYPED_TEST_P(InvalidatorTest, Basic) {
  ...
  this->delegate_.TriggerOnInvalidatorStateChange(
      OperaInvalidatorState(INVALIDATIONS_ENABLED));
  EXPECT_EQ(INVALIDATIONS_ENABLED, handler.GetInvalidatorState().state);
#else
...
#if defined(OPERA_SYNC)
  this->delegate_.TriggerOnInvalidatorStateChange(
      OperaInvalidatorState(TRANSIENT_INVALIDATION_ERROR));
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR, handler.GetInvalidatorState().state);
#else
...
#if defined(OPERA_SYNC)
  this->delegate_.TriggerOnInvalidatorStateChange(OperaInvalidatorState(
    INVALIDATION_CREDENTIALS_REJECTED));
  EXPECT_EQ(INVALIDATION_CREDENTIALS_REJECTED,
            handler.GetInvalidatorState().state);
#else
  this->delegate_.TriggerOnInvalidatorStateChange(
    INVALIDATION_CREDENTIALS_REJECTED);
  EXPECT_EQ(INVALIDATION_CREDENTIALS_REJECTED,
...
TYPED_TEST_P(InvalidatorTest, MultipleHandlers) {
  ...
  this->delegate_.TriggerOnInvalidatorStateChange(
      OperaInvalidatorState(INVALIDATIONS_ENABLED));
  EXPECT_EQ(INVALIDATIONS_ENABLED, handler1.GetInvalidatorState().state);
  EXPECT_EQ(INVALIDATIONS_ENABLED, handler2.GetInvalidatorState().state);
  EXPECT_EQ(INVALIDATIONS_ENABLED, handler3.GetInvalidatorState().state);
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR, handler4.GetInvalidatorState().state);
#else
  this->delegate_.TriggerOnInvalidatorStateChange(INVALIDATIONS_ENABLED);
  ...
  this->delegate_.TriggerOnInvalidatorStateChange(
      OperaInvalidatorState(TRANSIENT_INVALIDATION_ERROR));
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR, handler1.GetInvalidatorState().state);
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR, handler2.GetInvalidatorState().state);
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR, handler3.GetInvalidatorState().state);
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR, handler4.GetInvalidatorState().state);
#else
  this->delegate_.TriggerOnInvalidatorStateChange(TRANSIENT_INVALIDATION_ERROR);
...
class BoundFakeInvalidationHandler : public FakeInvalidationHandler {
 public:
  ...
  // changed.
#if defined(OPERA_SYNC)
  OperaInvalidatorState GetLastRetrievedState() const;
#else
...
#if defined(OPERA_SYNC)
  void OnInvalidatorStateChange(OperaInvalidatorState state) override;
#else
...
#if defined(OPERA_SYNC)
  OperaInvalidatorState last_retrieved_state_;
#else
...
TYPED_TEST_P(InvalidatorTest, GetInvalidatorStateAlwaysCurrent) {
  ...
  this->delegate_.TriggerOnInvalidatorStateChange(
      OperaInvalidatorState(INVALIDATIONS_ENABLED));
  EXPECT_EQ(INVALIDATIONS_ENABLED, handler.GetInvalidatorState().state);
  EXPECT_EQ(INVALIDATIONS_ENABLED, handler.GetLastRetrievedState().state);
#else
  this->delegate_.TriggerOnInvalidatorStateChange(INVALIDATIONS_ENABLED);
  EXPECT_EQ(INVALIDATIONS_ENABLED, handler.GetInvalidatorState());
  ...
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR, handler.GetInvalidatorState().state);
  EXPECT_EQ(TRANSIENT_INVALIDATION_ERROR,
            handler.GetLastRetrievedState().state);
#else
  this->delegate_.TriggerOnInvalidatorStateChange(TRANSIENT_INVALIDATION_ERROR);
