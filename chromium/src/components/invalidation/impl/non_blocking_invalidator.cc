...
class NonBlockingInvalidator::Core
 ...
 public:
  ...
  void OnInvalidatorStateChange(OperaInvalidatorState reason) override;
#else
...
#if defined(OPERA_SYNC)
OperaInvalidatorState NonBlockingInvalidator::GetInvalidatorState() const {
#else
...
#if defined(OPERA_SYNC)
void NonBlockingInvalidator::OnInvalidatorStateChange(OperaInvalidatorState state) {
#else
