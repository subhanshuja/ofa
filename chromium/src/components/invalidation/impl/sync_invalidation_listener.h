 ...
 public:
  ...
  class INVALIDATION_EXPORT Delegate {
   public:
    ...
    virtual void OnInvalidatorStateChange(OperaInvalidatorState state) = 0;
#else
...
#if defined(OPERA_SYNC)
      OperaInvalidatorState invalidator_state) override;
#else
...
#if defined(OPERA_SYNC)
  OperaInvalidatorState GetState() const;
#else
...
#if defined(OPERA_SYNC)
  OperaInvalidatorState ticl_state_;
  OperaInvalidatorState push_client_state_;
#else
