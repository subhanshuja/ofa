...
const char kOperaSyncEncryptionBootstrapToken[] =
    "sync.opera_encryption_bootstrap_token";
const char kOpSyncEncryptionBootstrapToken[] =
    "sync.op_encryption_bootstrap_token";
const char kOperaLastSignedInID[] = "sync.opera_last_signed_in_id";
#endif  // OPERA_SYNC
