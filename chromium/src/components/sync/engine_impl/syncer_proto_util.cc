...
// We want to export ServerConnectionErrorAsSyncerError, so remove it from
// anonymous namespace.
}  // namespace
#endif
...
#if defined(OPERA_SYNC)
    case HttpResponse::LOAD_BALANCER_ERROR:
      return SERVER_RETURN_TRANSIENT_ERROR;
#endif
...
#if defined(OPERA_SYNC)
// Continue anonymous namespace broken before ServerConnectionErrorAsSyncerError
namespace {
#endif
