...
struct SyncCredentials {
  ...
  // Secret for the token. Might be empty for some protocols.
  std::string sync_token_secret;

  // Time skew, offset timestamp sent in some protocols with this many seconds.
  // Should in a perfect world always be 0.
  int64_t sync_time_skew;
