...
void HttpBridge::MakeAsynchronousPost() {
  ...
  fetch_state_.url_poster->SetAutomaticallyRetryOn5xx(false);
  fetch_state_.url_poster->SetAutomaticallyRetryOnNetworkChanges(false);
#endif  // OPERA_SYNC
  fetch_state_.url_poster->SetLoadFlags(
      net::LOAD_BYPASS_CACHE | net::LOAD_DISABLE_CACHE |
      net::LOAD_DO_NOT_SAVE_COOKIES | net::LOAD_DO_NOT_SEND_COOKIES);
  fetch_state_.url_poster->SetStopOnRedirect(true);
