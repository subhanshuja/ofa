...
// @copied-from chromium/src/chrome/renderer/web_apps.cc
// @final-synchronized

#ifndef CHILL_RENDERER_WEBAPPS_WEB_APPS_H_
#define CHILL_RENDERER_WEBAPPS_WEB_APPS_H_
...
#endif  // CHILL_RENDERER_WEBAPPS_WEB_APPS_H_
