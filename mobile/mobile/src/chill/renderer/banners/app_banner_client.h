...
// @copied-from chromium/src/chrome/renderer/banners/app_banner_client.h
// @final-synchronized

#ifndef CHILL_RENDERER_BANNERS_APP_BANNER_CLIENT_H_
#define CHILL_RENDERER_BANNERS_APP_BANNER_CLIENT_H_
...
#endif  // CHILL_RENDERER_BANNERS_APP_BANNER_CLIENT_H_
