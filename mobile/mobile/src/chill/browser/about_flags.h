...
// @copied-from chromium/src/chrome/browser/about_flags.h
// @last-synchronized ba84619e63fb09545be28988bad3c8ddb5fb6adc

#ifndef CHILL_BROWSER_ABOUT_FLAGS_H_
#define CHILL_BROWSER_ABOUT_FLAGS_H_
...
void ConvertFlagsToSwitches(
    const scoped_refptr<opera::FlagsJsonStorage>& flags_storage,
...
#endif  // CHILL_BROWSER_ABOUT_FLAGS_H_
