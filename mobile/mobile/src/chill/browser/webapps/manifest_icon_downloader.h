...
// @copied-from chrome/browser/manifest/manifest_icon_downloader.h
// @final-synchronized

#ifndef CHILL_BROWSER_WEBAPPS_MANIFEST_ICON_DOWNLOADER_H_
#define CHILL_BROWSER_WEBAPPS_MANIFEST_ICON_DOWNLOADER_H_
...
#endif  // CHILL_BROWSER_WEBAPPS_MANIFEST_ICON_DOWNLOADER_H_
