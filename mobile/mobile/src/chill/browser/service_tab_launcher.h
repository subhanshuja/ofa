...
// @copied-from chromium/src/chrome/browser/android/service_tab_launcher.h

#ifndef CHILL_BROWSER_SERVICE_TAB_LAUNCHER_H_
#define CHILL_BROWSER_SERVICE_TAB_LAUNCHER_H_
...
#endif  // CHILL_BROWSER_SERVICE_TAB_LAUNCHER_H_
