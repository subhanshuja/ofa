...
// @copied-from chromium/src/chrome/browser/android/background_sync_launcher_android.h
// @final-synchronized

#ifndef CHILL_BROWSER_BACKGROUND_SYNC_BACKGROUND_SYNC_LAUNCHER_ANDROID_H_
#define CHILL_BROWSER_BACKGROUND_SYNC_BACKGROUND_SYNC_LAUNCHER_ANDROID_H_
...
#endif  // CHILL_BROWSER_BACKGROUND_SYNC_BACKGROUND_SYNC_LAUNCHER_ANDROID_H_
