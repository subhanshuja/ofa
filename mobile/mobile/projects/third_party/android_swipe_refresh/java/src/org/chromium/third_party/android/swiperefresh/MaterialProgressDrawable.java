 ...
 * @copied-from chromium/src/third_party/android_swipe_refresh/java/src/org/chromium/third_party/android/swiperefresh/MaterialProgressDrawable.java
 */
...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    //private static final float CENTER_RADIUS = 10.5f;
    //private static final float STROKE_WIDTH = 2.5f;

    private static final int CIRCLE_DIAMETER = 40;
    private static final float CENTER_RADIUS = 12.5f;
    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (mShowArrow) {
                ...
                float inset = (int) mArrowWidth / 2f * mArrowScale;
