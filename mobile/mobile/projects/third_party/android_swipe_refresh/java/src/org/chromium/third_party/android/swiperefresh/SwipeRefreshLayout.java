 ...
 * @copied-from chromium/src/third_party/android_swipe_refresh/java/src/org/chromium/third_party/android/swiperefresh/SwipeRefreshLayout.java
 */
...
public class SwipeRefreshLayout extends ViewGroup {
     ...
     * @param colorRes Resource id of the color.
     */
    public void setStrokeColorResource(int colorRes) {
        mCircleView.setStrokeColor(getResources().getColor(colorRes));
    }
