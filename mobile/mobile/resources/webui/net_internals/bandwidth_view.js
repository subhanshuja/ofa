...
// @copied-from chromium/src/chrome/browser/ui/webui/net_internals/bandwidth_view.js
...
var BandwidthView = (function() {
  ...
  BandwidthView.prototype = {
    ...
    updateBandwidthUsageTable_: function() {
      ...
      /* TODO(ohrn): Reenable when historic data is implemented.
      ...
      */
      ...
      /* TODO(ohrn): Reenable when OperaNetworkDelegate collects turbo stats.
      rows.push({
          title: 'Savings (KB)',
          sessionValue:
