...
#ifndef COMMON_OAUTH2_NETWORK_MIGRATION_TOKEN_RESPONSE_H_
#define COMMON_OAUTH2_NETWORK_MIGRATION_TOKEN_RESPONSE_H_
...
class MigrationTokenResponse {
 public:
  ...
  std::string error_description() const { return error_description_; }
...
#endif  // COMMON_OAUTH2_NETWORK_MIGRATION_TOKEN_RESPONSE_H_
